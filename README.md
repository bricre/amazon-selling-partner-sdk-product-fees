# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Product Fees
...
```shell
composer require bricre/amazon-selling-partner-sdk-product-fees
```
...
```php
<?php
use Amz\ProductFees\ResponseTypes;
